...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('enroll_verificationtoken', (
            ('verification_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.send_create_signal('enroll', ['VerificationToken'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'VerificationToken'
        db.delete_table('enroll_verificationtoken')
